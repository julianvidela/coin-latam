...
const ArticleSection = () => {
    return ( <main className="h-[50rem] md:h-[30rem] lg:h-[35rem] w-full flex flex-col items-center justify-center gap-10 z-1">
        <div className="text-white flex flex-col items-center gap-1 text-center ">
            <h2 className="text-[20px] md:text-[35px]  text-[#ADA5FF] font-light">Informacion al momento</h2>
            <p className="text-[var(--color-text-gray)] text-[14px] md:text-[16px] w-[70%] lg:w-full">Todos los datos de las criptos mas importantes del momento</p>
