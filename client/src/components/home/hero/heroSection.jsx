...
const hero = () => {
  return (
    <main className="h-[35rem] md:h-[60rem] lg:h-[40rem] w-full justify-center m-auto mt-4 flex flex-col lg:flex-row items-center gap-16 md:gap-6">
      <section className="h-[20rem] lg:h-[30rem] w-full flex flex-col bg-[rgba(17, 17, 17, 0.8)] rounded-xl lg:gap-2 p-8">
        ...
        <div className="flex flex-col items-center lg:items-start w-full gap-6  lg:w-full">
          <p className=" w-[70%] lg:w-[70%] text-center lg:text-left text-[#B0B0B0] text-[15px] md:text-[16px]">
      ...
      <div className="hidden h-[35rem] md:flex md:items-center">
